...
export default function CancellationPage() { return <LegalDocument eyebrow="REGRAS COMERCIAIS" title="Cobrança, cancelamento e reembolso" summary="A CandTech recebe pagamentos exclusivamente por Pix, com conferência manual antes da liberação do acesso.">
  ...
  <h2>Pix não confirmado</h2><p>Se o pagamento não for confirmado até o prazo informado, a solicitação expira e o acesso operacional é suspenso. O titular recebe por e-mail orientação para <a href="/exportar-dados">exportar os dados disponíveis</a> mediante login e MFA, sem anexo financeiro no e-mail. A exportação não substitui backup completo nem impede posterior regularização.</p>
</LegalDocument>; }
