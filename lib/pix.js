import { SUBSCRIPTION_PRICING } from "./subscription-pricing.js";
...
export function pixAmounts() {
  return {
    monthly: SUBSCRIPTION_PRICING.monthly,
    // Compatibilidade com o marcador histórico setup_paid_at; não é uma taxa extra.
    setup: SUBSCRIPTION_PRICING.firstMonth - SUBSCRIPTION_PRICING.monthly,
  };
}
