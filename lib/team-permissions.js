...
export const TEAM_AREAS = [
  ...
  { id: "financing", label: "Tabela financeira" },
  { id: "pricing", label: "Preço do produto" },
  { id: "cashflow", label: "Financeiro" },
  { id: "inventory", label: "Estoque e logística" },
  { id: "commerce", label: "Vendas e compras" },
...
const WORKSPACE_KEYS = {
  ...
  cashflow: ["cashEntries", "cashFilters", "financialCategories", "organizationName", "financialAccounts"],
