...
- a migration `migrations/20260831_financial_import_metadata.sql` adiciona lote, horário e fingerprint SHA-256 aos lançamentos, com índice único por organização; foi aplicada e verificada em Preview e Production antes do código consumidor;
- a migration `migrations/20260831_financial_commitment_terms.sql` adiciona ajustes, valor pago, recorrência e parcelamento aos compromissos, preenche liquidações antigas e valida valores e parcelas; foi aplicada e verificada em Preview e Production antes do código consumidor;
