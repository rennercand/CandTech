...
const INTERNAL_EVENTS = new Set([
  "history.created", "history.updated", "inventory.order.sale", "inventory.order.purchase", "inventory.order.cancelled", "delivery.created", "delivery.status_changed",
  "service.created", "service.approved", "service.scheduled", "service.in_progress", "service.cancelled", "service.completed",
]);
