...
import { createAuthSession, findActiveAuthSession, revokeAuthSession } from "@/lib/db";
...
export async function getSession(request) {
  ...
  try {
    ...
    return {
      id: Number(payload.sub), name: payload.name, email: payload.email,
      accountType: payload.accountType || "person", sessionHash,
    };
  } catch {
    return null;
  }
