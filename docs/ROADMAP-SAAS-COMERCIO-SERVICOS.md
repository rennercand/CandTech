...
**Progresso em 31/08/2026:** workspace e histórico concluíram a etapa gradual de escopo. Clientes, tarefas, entregas e o livro financeiro agora possuem tabelas relacionais próprias, FK organização, vínculos internos, backfill e marcadores de transição verificados em Preview e Production. A leitura relacional substitui os arrays legados após a migração e os testes negativos cobrem duas organizações. No estoque, `organization_id`, backfill coerente e índices foram aplicados em Preview e Production sem remover `tenant_id`; as novas escritas preenchem ambos e o teste cobre duas organizações reais. Faltam trocar as leituras e, em deploy posterior, retirar o identificador legado. Entregas ainda precisam da interface, eventos e comprovante, e o financeiro ainda precisa de importação/conciliação.
